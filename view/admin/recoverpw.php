                    ...
                    <div class="col-lg-5 col-md-12 align-self-center bg-primary py-3">
                        <div class="card p-0 mb-0">
                            <div class="card-body auth-card">
                                ...
                                <h1 class="reset-pw text-primary" align="center">Reset Password</h1>
                                <p class="mb-5 auth-desc"> Enter your email address and we'll send you an email with
                                ...
                                <form id="reset-password-form">
                                    ...
                                    <div id="otp-section" style="display: none;">
                                        <div class="custom-form-field">
                                            <input type="text" name="otp" id="otp" class="form-control mb-3" placeholder="Enter OTP *" required>
                                        </div>
                                        <div class="custom-form-field">
                                            <input type="password" name="new_password" id="new_password" class="form-control mb-3" placeholder="New Password *" required>
                                        </div>
                                    </div>
                                    <button type="button" id="reset-password-btn" class="btn btn-primary w-100">
