<?php
// Include GenreClass
require_once $_SERVER['DOCUMENT_ROOT'] . '/NovelNest/model/GenreClass.php';

$genreClass = new GenreClass();
$genres = $genreClass->getGenre(); // Fetch genres from the database
?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="" id="booksForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="genres" name="genres" required>
                                            <!-- Options will be populated by loadGenres() -->
                                        </select>
                                    </div>
                                    <div class="form-group">
